...
def phi3_interface(y,h,s,coll=True):
    ...
    if coll:
        ...
        if -h < y <= h:
            coarse = phi3(y/2+3*h/2,h)
        elif y > 0:
            coarse = phi3(y/2-5*h/2,h)
        else:
            coarse = phi3(y/2-h/2,h)
        # if -2*h < y <= -h:
        #     coarse = phi3((y-h)/2,h)
        # elif -h < y <= 0:
...
def phi3_interface_dy(y,h,s,coll=True):
    ...
    if coll:
        ...
        if -h < y <= h:
            d_coarse = phi3(y/2+3*h/2,h)/2
        elif y > 0:
            d_coarse = phi3(y/2-5*h/2,h)/2
        else:
            d_coarse = phi3(y/2-h/2,h)/2
        # if -2*h < y <= -h:
