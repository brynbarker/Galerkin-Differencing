...
class Solver:
	...
	def _build_force(self):
		...
		for e in self.mesh.elements:
			...
			for test_id,dof in enumerate(e.dof_list):
				...
				phi_test = lambda x,y: phi3_2d_ref(x,y,e.h,test_ind,False)
	...
	def _setup_constraints(self):
		...
		v0, v1, v2, v3 = phi3(3/2,1), phi3(1/2,1), phi3(-1/2,1), phi3(-3/2,1)

		for v, offset in zip([v0,v1,v2,v3],[1,0,-1,-2]):#ind,ID in enumerate(f_odd):
