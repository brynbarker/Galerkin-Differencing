...
class Solver:
	...
	def _build_stiffness(self):
		...
		kh_coarse_top = local_stiffness(2*self.h,qpn=self.qpn,half=0)
		kh_coarse_bot = local_stiffness(2*self.h,qpn=self.qpn,half=1)
		
		kh_fine_top = local_stiffness(self.h,qpn=self.qpn,half=0)
		kh_fine_bot = local_stiffness(self.h,qpn=self.qpn,half=1)
